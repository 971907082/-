...
public class EmailUtil {
    ...
    private static final String SHOUQUANMA = "hpydjdhbpfgvbcde";
    //  pljndhlocfumbede
...
// 指明邮件的发件人
        message.setFrom(new InternetAddress("971907082@qq.com"));
...
// 连接邮件服务器：邮箱类型，帐号，授权码代替密码（更安全）
        ts.connect("smtp.qq.com", "971907082", SHOUQUANMA);//后面的字符是授权码，用qq密码反正我是失败了（用自己的，别用我的，这个号是我瞎编的，为了。。。。）
// 创建邮件
...
// 发送邮件
    ...
    public static void main(String[] args) throws Exception {
        sendEmail("123456","971907082@qq.com");
    }
}
